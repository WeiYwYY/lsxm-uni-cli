let mask = document.querySelector("#file-uploader-mask");
let fileDom = document.getElementById("file-uploader-input");
let tis = document.querySelector("#file-uploader-tis");
let progress = document.querySelector("#file-uploader-tis-progress");
let cancel = document.querySelector("#file-uploader-cancel-btn");

/* 上传方法
 * @param file 文件信息
 * @param url 后端文件上传请求的URL
 * @param key 文件对应的name
 * @param header 头部信息
